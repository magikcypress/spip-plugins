...
function formulaires_editer_monitor_charger_dist(){
	...
	$valeurs['status'] = sql_allfetsel('id_syndic,type,status', 'spip_monitor', 'id_syndic=' . $id_syndic);
...
function formulaires_editer_monitor_traiter_dist(){
	...
	if (!$syndic) {
		sql_insertq('spip_monitor',array('id_syndic'=>$id_syndic, 'status'=>_request('activer_monitor_ping') ,'type'=>_request('activer_monitor_ping_type')));
		sql_insertq('spip_monitor',array('id_syndic'=>$id_syndic, 'status'=>_request('activer_monitor_poids') ,'type'=>_request('activer_monitor_poids_type')));
	} else {
		...
		sql_updateq('spip_monitor', array('status'=>_request('activer_monitor_ping')), 'id_syndic=' . $id_syndic . 'and type like "' . _request('activer_monitor_ping_type') . '"');
		sql_updateq('spip_monitor', array('status'=>_request('activer_monitor_poids')), 'id_syndic=' . $id_syndic . 'and type like "' . _request('activer_monitor_poids_type') . '"');
	}
