...
function formulaires_bigbluebutton_abonnement_groups_charger_dist() {

        $valeurs = array('editable' => ' ', 'bbb_attendee_email' => '');
...
function formulaires_bigbluebutton_abonnement_groups_verifier_dist() {
      $erreurs = array();
...
function formulaires_bigbluebutton_abonnement_groups_traiter_dist() {
	include_spip('base/abstract_sql');
        include_spip('bbb_api');

	// On récupère les champs
	$bbb_meeting_room_name = _request('bbb_meeting_room_name');
        $bbb_attendee_name = _request('bbb_groups_name');
